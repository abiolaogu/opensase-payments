...
flowchart LR
  ...
  API --> P1["Pulsar Topic: persistent://billyronks/extract-payments/command"]
  API --> P2["Pulsar Topic: persistent://billyronks/extract-payments/event"]
  API --> P3["Pulsar Topic: persistent://billyronks/extract-payments/audit"]
  API --> O["Pulsar Topic: persistent://billyronks/global/observability"]
  P1 --> W["Workers / Domain Services"]
  P2 --> W
  P3 --> W
  W --> Q["Quickwit Index: logs-extract-payments"]
  API --> Q
```
